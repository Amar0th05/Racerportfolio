...
const bestHighlights = [
  "🏁 First Indian to clock fastest Lap time on stocle RC390 Indian spec - 159.030",
  "🏍️ Lap record @ First Indian to bold fastest lap record time on Indian spec GT650 - 16.513",
