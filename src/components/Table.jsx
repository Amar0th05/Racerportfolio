          ...
          <tbody>
            {data.map((item, index) => (
              <motion.tr
                ...
                transition={{ type: "spring", stiffness: 80, delay: index * 0.08 }}
                viewport={{ once: true }}
              >
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.SNO}</td>
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.DATA}</td>
                <td className="p-2 sm:p-3 border border-gray-700">{item.EVENT}</td>
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.CATEGORY}</td>
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.VENUE}</td>
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.POSITION}</td>
                <td className="p-2 sm:p-3 border border-gray-700 text-center">{item.RESULT}</td>
              </motion.tr>
            ))}
          </tbody>
        </table>
